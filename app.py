...
<style>
    ...
    /* Suchfelder zunächst etwas zurückhaltend */
...
def mark_item_as_found(item_id):
    ...
    if filename:
        ...
        image_path = UPLOAD_DIR / str(filename)
...
def parse_search_date(date_text):
