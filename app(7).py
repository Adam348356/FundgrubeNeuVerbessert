...
<style>
    ...
    /* Das gesamte graue Feld ist anklickbar.
       Der vorhandene Streamlit-Button liegt unsichtbar über
       der kompletten Karte und übernimmt weiterhin die Navigation. */
    /* Zuverlaessige Klickflaeche ueber der kompletten Karte. */
    ...
    .st-key-latest_selector .stButton > button:focus,
    .st-key-oldest_selector .stButton > button:focus {
        background: transparent !important;
        border: 0 !important;
        box-shadow: none !important;
    }
